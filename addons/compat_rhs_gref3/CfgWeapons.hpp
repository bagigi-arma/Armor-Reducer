...
class CfgWeapons {
	// HEADGEAR
	class rhs_fieldcap;
	class rhs_fieldcap_digi2: rhs_fieldcap {class ItemInfo;};
	...
	class UniformItem;
	class Uniform_Base;
	class rhsgref_uniform_ttsko_forest: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_ttsko_mountain: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_ttsko_urban: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_vsr: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_para_ttsko_oxblood: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_para_ttsko_mountain: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_para_ttsko_urban: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_specter: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_reed: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_alpenflage: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_flecktarn: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_flecktarn_full: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_tigerstripe: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_woodland: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_woodland_olive: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_ERDL: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_og107: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_og107_erdl: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_altis_lizard: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_olive: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_altis_lizard_olive: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_dpm: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_dpm_olive: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_3color_desert: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_gorka_1_f: Uniform_Base {CONTAINER_SUPPLY70;};
	class U_IG_leader: Uniform_Base {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_TLA_1: U_IG_leader {CONTAINER_SUPPLY70;};
	class rhsgref_uniform_TLA_2: U_IG_leader {CONTAINER_SUPPLY70;};
};
